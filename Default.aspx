        ...
        <div>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td><asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" DataTextField="Stat" DataValueField="Stat"  OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" DataSourceID="sdsStatus"></asp:DropDownList></td>
            ...
            <asp:SqlDataSource ID="sdsProposals" runat="server" 
                ...
                SelectCommand="SELECT [TypeOfNeed], [Description], [Title], [ClientType], [OrganizationCategory] FROM [Projects],[StatusCode] WHERE (([OrganizationCategory] LIKE @OrganizationCategory + '%') AND (( [TypeOfNeed] LIKE @TypeOfNeed + '%')AND (( [ClientType] LIKE @ClientType + '%') ORDER BY [Title]">
